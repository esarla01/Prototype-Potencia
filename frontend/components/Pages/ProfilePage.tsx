...
import ColoredBox from './JumpingOffPoint';
import AppContext from '../AppContext';


export default function ProfilePage(props: { navigation: { navigate: (arg0: string) => void; }, user: {
        userType: string,
        userName: string,
        firstName: string,
        lastName: string,
            ...
            <View style={{flexDirection: "column", padding: 5, marginTop:5}}>
                ...
                <View style={styles.box}>
                    <View>
                        ...
                        <Text>{myContext.user.achievements}</Text>
