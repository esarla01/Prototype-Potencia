...
const RemindersTutorPage = (props: { navigation: { navigate: (arg0: string) => void; }, user: {
  userType: string,
  userName: string,
  firstName: string,
  lastName: string,
  ...
  const handleButtonPress = (buttonId) => {
    // console.log("Pressed!! buttonId: ", buttonId)
    setSelectedButton(buttonId);
  }

  async function handleSubmit() {
    props.navigation.navigate('Welcome2Tutor')
  ...
  return (
    <View style={styles.body}>
      ...
      <View style={styles.bottom}>
        <Pressable style={styles.back} onPress={() => handleSubmit()}>
          <Text style={styles.back}>Back</Text>
        </Pressable>
        <Image style={styles.dots} source={require('../OnBoarding/img/dots5.png')}></Image>
...
export default RemindersTutorPage;
